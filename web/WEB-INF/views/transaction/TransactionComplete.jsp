...
<div class="wrapper rounded-5" id="header">
    ...
    <section class="bg-dark">
        ...
        <div class="justify-content-center text-light align-self-center m-5 w-100 h-75" id="register"
             style="font-family: NeoDunggeunmoPro-Regular, serif, white; display: grid; width: 100%">
            <div class="d-grid align-items-center">
                <div class="justify-content-center align-items-center">
                    <h1 class="m-3 w-100 h-75" style="display: flex; align-items: center;">주문 완료! :) </h1></div>
            </div>
        </div>
    </section>
</div>
