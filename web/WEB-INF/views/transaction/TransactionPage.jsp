    ...
    <section class="bg-dark">
        ...
        <div class="justify-content-center text-light align-self-center m-5" id="register"
            ...
            <div class="d-grid align-items-center">
                ...
                <c:forEach var="nm" items="${transactionList}" varStatus="statusNm">
                    <div class="m-3 d-flex align-items-center align-content-center justify-content-center">
                        <div class="align-items-center">
                            ...
                            <div>
                                <div class="align-items-center">
                                    <div class="display-5 m-3">${productList[statusNm.index].productName}</div>
                                    <div class="display-6 m-3">${transactionList[statusNm.index].price}원</div>
                                    <div class="display-6 m-3">${transactionList[statusNm.index].count} 개</div>
                ...
                <div class="justify-content-end display-5">총합: ${totalPrice}원</div>
                <div class="d-grid m-4 justify-content-center align-items-center" style="grid-auto-flow: column">
                    <div>
                        <div class="justify-content-center">
                            <form class = "m-2" action="/transaction/deleteAll/${userId}">
                                <button class="display-5 m-2 btn btn-danger btn-lg" type="submit">전체 삭제
                                </button>
                            </form>
                            <div class="align-items-center">
                                <button class="display-5 m-2 btn btn-success btn-lg" location.href="/transaction/transactionComplete/${userId}">주문
                                </button>
                            </div>
