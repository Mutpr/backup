...
class Magazine extends Book { //food 상속하는 melon 클래스 작성
	private String info; //경작 농원 정보
	
	public Magazine(String name, String page, String author, String info) { //생성자 매개변수
		//가격과 중량 정보 다 받아 옴
		//부모 클래스의 매개변수 전부 받아와서 필요한 값 전달
		super(name,page,author); //Food 의 생성자 호출
		this.info = info; 
	}
