...
public interface ApiDetailsDao {
    ...
    int countAll(int apisId) throws DataAccessException;
    List<ApiDetailsDTO> apisDetailsList (HashMap<String, Integer> params) throws DataAccessException;
    List<ResourceDTO> resourceListPaging(HashMap<String, Integer> params) throws DataAccessException;
